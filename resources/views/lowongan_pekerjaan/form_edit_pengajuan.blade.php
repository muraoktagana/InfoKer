...
<head>
    ...
    <title>Lowongan Pekerjaan-Form Edit</title>
    @extends('navigasi')
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 class="card-title my-0">Form Edit</h4>
                        <!-- Button trigger modal -->

                    </div>
                    <div class="card-body">

                        <form action="/lowongan_pekerjaan/update{{ $lowongan->id }}" method="post" id="form_lowongan"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" id="alamat_perusahaan" name="alamat_perusahaan" class="form-control" required="required" autofocus
                                        value="{{ $lowongan->perusahaan->alamat_perusahaan }}">
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select" name="lokasi_kerja" id="lokasi_kerja" required="required">
                                        ...
                                        <option value="on_site" {{ $lowongan->lokasi_kerja == 'on_site' ? 'selected' : '' }}>On
                                            Site</option>
                                        <option value="remote" {{ $lowongan->lokasi_kerja == 'remote' ? 'selected' : '' }}>
                                            Remote</option>
                                        <option value="hybrid" {{ $lowongan->lokasi_kerja == 'hybrid' ? 'selected' : '' }}>
                                            Hybrid</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div id="deskripsi_editor" class="mb-4">{!! $lowongan->deskripsi !!}</div>
