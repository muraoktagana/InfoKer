            ...
            <div class="page-title">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 order-md-2 order-first">
                        <form action="/infoker" method="post">
                            @csrf
                                ...
                                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                                    ...
                                    <div>
                                        @if (isset($lowongan->alumni->foto_profil))
                                            <img src="storage/{{ $lowongan->alumni->foto_profil }}" alt=""
                                    ...
                                    <div class="d-flex justify-content-between mb-4">
                                        ...
                                        <div class="text-end">
                                            <button type="button"
                                                ...
                                                {{ Auth::user()->level == 'alumni' ? 'disabled' : '' }}>
                                                {{ $lowongan->status == 'active' ? 'Dibuka' : 'Ditutup' }}
                                            </button>
                                            <!--small size modal -->
                                            <div class="modal fade text-left" id="status" tabindex="-1" role="dialog"
