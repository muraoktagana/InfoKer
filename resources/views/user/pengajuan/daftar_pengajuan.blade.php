            ...
            <div class="page-title">
                <div class="row">
                    ...
                    <div class="col-12 col-md-8 order-md-2 order-first">
                        <h3>Daftar Pengajuan Lowongan</h3>
                    </div>
                            ...
                            <div id="accordion{{ $lowongan->id }}" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <div class="d-flex justify-content-between mb-4">
                                        ...
                                        <div class="text-end">
                                            <button type="button"
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#status{{ $lowongan->id }}" {{ Auth::user()->level=='alumni' ? 'disabled' : '' }}>
                                    ...
                                    <div class="accordion-footer mt-5 text-end">
                                        <a href="/pengajuan-form_edit{{ $lowongan->id }}" class="mx-2">
